...
Enter your name as the author above.

## Introduction

(1) How do various countries vote in the United Nations General Assembly?
(2) How have their voting patterns evolved throughout time
(3) How similarly or differently do they view certain issues? 

Answering these questions (at a high level) is the focus of this analysis.

### Packages

We will use the **tidyverse**, **lubridate**, and **scales** packages for data wrangling and visualization, and the **DT** package for interactive display of tabular output, and the **unvotes** package for the data.  Note that the `DT` and `unvotes` packages must be installed in your RStudio environment.
...
Now update the visualization by graphing data for three different countries.
